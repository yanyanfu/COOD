...
print('train raw', len(raw_data_train))
    ...
    for idx_x in tqdm.tqdm(range(length)):
        ...
        for i in range(num_negative):
            train_data_withneg.append({'idx': idx_x+length+1,
                                    ...
                                    'raw': random_selected[i]['raw'],
                                    'label': 0})
print('train with neg', len(train_data_withneg))
...
print('valid raw', len(raw_data_valid))
